...
showQuestionBtns.forEach((btn) => {
  ...
  btn.addEventListener("click", showAnswer);
  // btn.addEventListener("animationend", hideAnswer);
});
function showAnswer(e) {
  const answerArea = e.target.parentElement.nextElementSibling;
  // answerArea.style.animationName = "showAnswer";
  answerArea.classList.toggle("showAnswer");

  // const answerText = e.target.parentElement.nextElementSibling.children[0];
...
function openMobileNav() {
  ...
  // mobileNav.style.animationName = "openMobileNav";
...
let users = [
  ...
  { name: "Siyasanga", email: "siyasanga@gmail.com", password: "orange" },
  { name: "Swaleha", email: "swaleha@gmail.com", password: "peach" },
  { name: "Luyanda", email: "Luyanda@gmail.com", password: "pear" },
];
...
function goBackToLobby() {
  ...
  // successfulPurchasePopup.style.display = "none";
  // successfulPurchasePopup.style.zIndex = "-1";
